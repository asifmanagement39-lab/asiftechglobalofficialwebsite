...
set "PROFILE_DIR=%~dp0yt_bot\Saved_YT_Session"
if not exist "%PROFILE_DIR%" mkdir "%PROFILE_DIR%"

echo Opening Chrome to log in to your YouTube / Google account...
echo.
echo 1. Apne Google / YouTube account se sign in karein.
echo 2. Login complete hone ke baad Chrome window ko BAND (CLOSE) kar dein.
echo.
...
echo Uske baad start_bot_server.bat chala kar "Start Live Bot" dabayein.
echo.
pause
